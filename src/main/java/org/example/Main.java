...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            Student student=new Student(10,"20491A0546","Yedukondalu");
            session.save(student);
            CurrentStudent currentStudent=new CurrentStudent(20,"20491A0545","BHUVS",300,"Kondalu","9:30AM");
            session.save(currentStudent);
            OldStudent oldStudent=new OldStudent(30,"20491A0540","Vamsi",40,"MVAmsi","vamsi98@gmail.com");
            session.save(oldStudent);
            WeklyStudent weklyStudent=new WeklyStudent(40,"20491A0545","Bhuvana",3000,"kondalu","10:30","Bhvss","11.30");
            session.save(weklyStudent);
            WeekendStudent weekendStudent=new WeekendStudent(50,"20491A0538","KASI",4000,"Kondalu","12:AM",38,"AKKA");
